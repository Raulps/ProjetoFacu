...
$queryVerificarEmail = mysqli_query($conexao,"SELECT * FROM usuario WHERE email='$email'");
$rowsEmails = mysqli_num_rows($queryVerificarEmail);
if($rowsEmails <=0){
    $queryInserirDados = "INSERT INTO `usuario`(`nome`,`email`,`senha`) VALUES ('$nome','$email','$senha')";
